...
\subsection{Validation}
Based on the data from the 1000G Phase 1 data set and the Danish cohort presented earlier (see Evalation \ref{subs:evaluation}), we reassess the haplogroup classification available in HaploGrep 2 \footnote{\url{http://haplogrep.uibk.ac.at}} and the optimized version based on different set ups:
