...
\subsection{Algorithm for the MultiMap Approach}
...
\subsection{Performance Validation of MultiMap}
...
\begin{table}[H]
\centering
\caption{Runtime of different HaploGrep versions (HaploGrep as presented in \cite{Kloss-Brandstatter2011} and HaploGrep 2 as presented in \cite{weissensteiner2016haplogrep} compared to a new MultiMap approach (unpublished)}
\label{hg:runtime1}
